package com.aicodegenerate.langgraph4j.tools;
...
import com.aicodegenerate.langgraph4j.model.enums.ImageCategoryEnum;
...
public class MermaidDiagramTool {
    ...
    public List<ImageResource> generateMermaidDiagram(@P("Mermaid 图表代码") String mermaidCode,
        ...
        try {
            ...
            // 上传到COS
            String keyName = String.format("/aicodegenerate/mermaid/%s/%s",
